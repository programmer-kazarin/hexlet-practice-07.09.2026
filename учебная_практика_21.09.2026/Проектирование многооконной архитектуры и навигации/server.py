...
def partner_edit_window():
    """
    PartnerEditWindow — форма добавления/редактирования партнера.
    Сейчас только рендерит статичную верстку, никакой логики работы с БД нет 
    # TODO (backend).
    """
